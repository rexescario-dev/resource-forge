...
Governing contract: [Process Specification: Standardized Agent Workflows](../specs/agent-workflow-design.md) · Stage **M8** · Conventions: [prompt-library.md](../conventions/prompt-library.md)
...
**Refactoring complete (or not applicable)** — Either maintainability improvements landed with unchanged externally observable behavior and green before/after verification (**Complete**), an explicit **N/A** decision is recorded, or **Deferred** until safe characterization/verification exists. No semantic redesign.
