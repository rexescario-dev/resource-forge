...
RFC-001–004 and the [M2 implementation plan](superpowers/plans/2026-08-06-m2-implementation-plan.md) are accepted. Next gate: accept the [M2.1 identity task plan](superpowers/plans/2026-08-06-m2-1-identity-primitives.md), then implement identity only. See the [RFC review checklist](rfc-review-checklist.md).
