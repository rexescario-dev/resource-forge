...
| M3 | Resource model | In progress — M3.1–M3.26 ✅; RFC-030 Accepted; [M3.27](superpowers/plans/2026-08-10-m3-27-relation-metadata-projection.md) docs/verification closeout in progress ([#102](https://github.com/rexescario-dev/resource-forge/issues/102)) |
