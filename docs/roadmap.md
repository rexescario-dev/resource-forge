...
| M3 | Resource model | In progress — M3.1–M3.9 ✅; next optionality / vocabulary / ops-kind RFCs as needed |
...
- **M3.10+** — deferred until nullability-constraints / operation kind-signature-execution / direction-join / vocabulary RFCs as needed
