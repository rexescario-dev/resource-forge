...
| M3 | Resource model | In progress — M3.1–M3.13 ✅; further slices deferred until concrete constraint kinds / operation kind-signature-execution / direction-join / vocabulary RFCs |
