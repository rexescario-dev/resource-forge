...
| M2 | Core contracts (vocabulary, not behavior) | Planned — [implementation plan](superpowers/plans/2026-08-06-m2-implementation-plan.md) (Accepted); M2.1 task breakdown next |
