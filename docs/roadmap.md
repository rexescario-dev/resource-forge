...
| M5 | CLI & end-to-end examples | In progress — M5.1 CLI Foundation ✅ · M5.2 validate Accepted (RFC-037) · [#121](https://github.com/rexescario-dev/resource-forge/issues/121) · [#124](https://github.com/rexescario-dev/resource-forge/issues/124) |
...
2. **M5.2 CLI Resource Validation** — thin `rf validate <file>` over core `validateResource` (RFC-037) Accepted — [#124](https://github.com/rexescario-dev/resource-forge/issues/124)
