...
| M3 | Resource model | In progress — M3.1–M3.21 ✅; remaining Later RFC (empty-vs-absent) |
...
| Later | Empty-vs-absent / null elements | Planned |
