...
| M2 | Core contracts (vocabulary, not behavior) | In progress — [M2.1 tasks](superpowers/plans/2026-08-06-m2-1-identity-primitives.md) Accepted; implementing identity |
