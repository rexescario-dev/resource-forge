...
| M3 | Resource model | In progress — M3.1–M3.11 ✅; further slices deferred until Relation nullability / operation kind-signature-execution / direction-join / vocabulary RFCs |
