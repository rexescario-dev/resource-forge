...
| M3 | Resource model | In progress — M3.1–M3.18 ✅; further slices deferred until remaining Later RFCs (annotation vocabulary / richer projection / direction-join / empty-vs-absent) |
...
| Later | Annotation vocabulary; richer projection; direction / joins; empty-vs-absent / null elements | Planned |
