...
| M3 | Resource model | In progress — M3.1–M3.16 ✅; further slices deferred until population-uniqueness / operation kind-signature-execution / direction-join / vocabulary RFCs |
