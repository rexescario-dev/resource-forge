...
| M3 | Resource model | In progress — M3.1–M3.10 ✅; further slices deferred until nullability / operation kind-signature-execution / direction-join / vocabulary RFCs |
