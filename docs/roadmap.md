...
6. **M5.6 CLI Generate from Prisma** — `rf generate from-prisma <dmmfPath> <outDir> --namespace <ns>` (RFC-041) — [#138](https://github.com/rexescario-dev/resource-forge/issues/138)
