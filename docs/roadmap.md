...
| RFC-011 | Relation Cardinality / Multiplicity (required `multiplicity: one\|many`) | Draft — [#31](https://github.com/rexescario-dev/resource-forge/issues/31) |
...
- **M3.8** — Relation Multiplicity per RFC-011 (Draft — [#31](https://github.com/rexescario-dev/resource-forge/issues/31)); implementation only after Accept + Accepted plan
