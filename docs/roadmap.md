...
| M2 | Core contracts (vocabulary, not behavior) | Planned — [M2 plan](superpowers/plans/2026-08-06-m2-implementation-plan.md) Accepted; [M2.1 tasks](superpowers/plans/2026-08-06-m2-1-identity-primitives.md) Draft |
