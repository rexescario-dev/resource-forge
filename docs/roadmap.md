...
| M3 | Resource model | In progress — M3.1–M3.24 ✅; remaining Later (persistence / traversal / Relation projection) |
...
| Later | Persistence/ORM mapping; runtime traversal/query; Relation→metadata projection | Planned |
