...
| M3 | Resource model | In progress — M3.1–M3.20 ✅; remaining Later RFCs (direction-join / empty-vs-absent) |
...
| Later | Direction / joins; empty-vs-absent / null elements | Planned |
