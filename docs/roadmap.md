...
| RFC-012 | Resource Operations (name-only Operation + ordered `operations` sequence) | Draft — [#36](https://github.com/rexescario-dev/resource-forge/issues/36) |
...
- **M3.9+** — deferred until RFC-012 Accept (Operations declaration floor) / nullability-constraints / direction-join / vocabulary RFCs as needed
