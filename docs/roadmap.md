...
| M3 | Resource model | In progress — M3.1–M3.10 ✅; RFC-014 Accepted; next Field Nullability plan + implementation; further slices deferred until Relation nullability / operation kind-signature-execution / direction-join / vocabulary RFCs |
...
- **M3.x** — Field Nullability per RFC-014 (Accepted — [#46](https://github.com/rexescario-dev/resource-forge/issues/46)); delivery slice pending (plan + implementation); further slices deferred until Relation nullability / operation kind-signature-execution / direction-join / vocabulary RFCs as needed
