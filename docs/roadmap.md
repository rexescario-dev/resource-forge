...
| M3 | Resource model | In progress — M3.1–M3.11 ✅; RFC-015 Accepted; next Relation Nullability plan + implementation; further slices deferred until constraints / operation kind-signature-execution / direction-join / vocabulary RFCs |
