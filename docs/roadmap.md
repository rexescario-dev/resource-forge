...
| M3 | Resource model | In progress — M3.1–M3.9 ✅; RFC-013 Accepted; next M3.10 plan + implementation |
...
- **M3.10** — Field/Relation Optionality per RFC-013 (Accepted — [#40](https://github.com/rexescario-dev/resource-forge/issues/40)); delivery slice pending (plan + implementation); further slices deferred until nullability / operation kind-signature-execution / direction-join / vocabulary RFCs as needed
