...
| M3 | Resource model | In progress — M3.1–M3.12 ✅; further slices deferred until constraints / operation kind-signature-execution / direction-join / vocabulary RFCs |
