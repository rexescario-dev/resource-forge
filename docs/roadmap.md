...
| M3 | Resource model | In progress — M3.1–M3.19 ✅; further slices deferred until remaining Later RFCs (richer projection / direction-join / empty-vs-absent) |
...
| Later | Richer projection; direction / joins; empty-vs-absent / null elements | Planned |
