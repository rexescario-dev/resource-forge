...
| M3 | Resource model | In progress — M3.1–M3.25 ✅; RFC-029 Accepted; M3.26 docs closeout in progress; remaining Later (Relation→metadata projection) |
...
| Later | Relation→metadata projection | Planned |
